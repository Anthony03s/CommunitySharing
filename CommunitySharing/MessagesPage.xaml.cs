...
namespace CommunitySharing
{
    public partial class MessagesPage : ContentPage
    {
        ...
        private void HighlightMessageTab(string selected)
        {
            if (selected == "All")
            {
                AllMessagesTab.BorderColor = Color.FromArgb("#34C759");
                RequestTab.BorderColor = Colors.Black;
            }
            else
            {
                AllMessagesTab.BorderColor = Colors.Black;
                RequestTab.BorderColor = Color.FromArgb("#34C759");
            }
        }
